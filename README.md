...
To have full log enable debug mode `"Debug": true`
...
If you encounter any bug, please open a issue with:

* Mattermost version
* Mattermail log using [debug mode](https://github.com/rodcorsi/mattermail#debug)
* config.json

Remember to **remove personal data** from log and config.json

## Contribute

If you want to help, please check the [issues](https://github.com/rodcorsi/mattermail/issues) or open a new one to discuss.
Do not forget to create tests and run the commands bellow before to make a pull request
